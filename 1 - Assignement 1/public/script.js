...
function registerUser(){
    ...
    if(input.value.length >= 3){
        ...
        username = input.value
        user_message.innerHTML = `You are not registered. Register to be able to see your drawings`
    }
}
...
canvas.addEventListener('mousedown', function(e) {
    if(username != ''){
        ...
        let user_message = document.getElementById('user_message')
        user_message.innerHTML = `<span style="color:darkred;">You must be registered to perform this action !</span>`
    }
